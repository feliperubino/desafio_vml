...
class Filtro extends React.Component {
  ...
  render() {
    ...
    return (
		...
		<div>
			<h2>Discover New Movies &amp; TV Shows<span className="right"><a className="movie selected" href="/discover/movie?language=en" alt="Search for new movies by different criteria such as years, ratings and genres." title="Search for new movies by different criteria such as years, ratings and genres.">Movies</a>&nbsp;&nbsp;<a className="tv" href="/discover/tv?language=en" alt="Search for new TV shows by different criteria such as years, ratings and genres." title="Search for new TV shows by different criteria such as years, ratings and genres.">TV Shows</a></span></h2>
